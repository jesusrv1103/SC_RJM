					...
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
						<div class="kt-login__container">
							<div class="kt-login__logo">
								<a href="#">
									<img src="/assets/logos_fiscalia/appbanner120x35.png" height="60%" width="70%">
								</a>
							</div>
							<div class="kt-login__signin">
								<div class="kt-login__head">
									<h3 class="kt-login__title">Bienvenido  al Sistema de Citas Para Tramitar el Registro de Mandamientos Judiciales</h3>
								</div>
								<form class="kt-form" role="form" method="POST" action="{{ route('login') }}">
                                        @csrf
									<div class="input-group">
                                        <input class="form-control @error('username') is-invalid @enderror" required type="text" placeholder="Nombre de Usuario" name="username" autocomplete="username" />
                                        @error('username')
